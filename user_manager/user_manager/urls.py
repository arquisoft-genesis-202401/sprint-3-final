...
from .views import  send_otp_to_phone, create_customer_application, create_update_application_basic_info, get_basic_information, get_customer_latest_application
